    ...
    >
      ...
      >
        <div data-aos="fade-right">
          <p className="text-[#13AFFE] dark:text-[#F5A623] uppercase tracking-[0.3em] text-xs font-bold mb-3">
            Google Reviews
          </p>
          <h2 className="text-4xl md:text-5xl text-[#13AFFE] font-bold uppercase tracking-wide leading-[1.1]">
        ...
        <button
          ...
          data-aos="zoom-in"
          data-aos-delay="200"
          className="mt-8 md:mt-0 flex items-center gap-2 bg-[#F5A623] hover:scale-105 text-white dark:text-[#0E0E0E] font-black uppercase tracking-wide px-8 py-4 rounded-xl transition-all duration-300 shadow-lg shadow-blue-500/20 dark:shadow-yellow-500/10"
        >
          Book Your Detail
          <svg
                ...
                <div className="min-w-0">
                  <div className="flex items-center gap-3">
                    <button
                      ...
                      className="shrink-0 flex h-10 w-10 items-center justify-center rounded-full bg-[#07081D]/95 text-white shadow-lg transition hover:bg-[#13AFFE] md:h-11 md:w-11"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        className="h-6 w-6"
                    ...
                    <div
                      ref={reviewTrackRef}
                      className="flex min-w-0 flex-1 snap-x gap-6 overflow-x-auto scroll-smooth pb-2 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden"
                    >
